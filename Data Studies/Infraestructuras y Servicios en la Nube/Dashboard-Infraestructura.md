...
- 🔴 Críticos (❓/🤔): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Infraestructura-Nube" && (p["nivel-comprension"] == "❓" || p["nivel-comprension"] == "🤔")).length`
- 🟡 En progreso (💡): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Infraestructura-Nube" && p["nivel-comprension"] == "💡").length`
- 🟢 Dominados (✅/🎯): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Infraestructura-Nube" && (p["nivel-comprension"] == "✅" || p["nivel-comprension"] == "🎯")).length`
...
WHERE tipo_nota = "tecnica"
  AND asignatura = "Infraestructura-Nube"
