...
**Estado general**: 🟡 Atrasado
**Próximo examen**: 2026-02-06 (en `$= Math.ceil((new Date("2026-02-06") - new Date()) / (1000 * 60 * 60 * 24))` días)
**Profesor**: Romi

**Estadísticas rápidas**:
- 🔴 Críticos (❓/🤔): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Fundamentos-DS" && (p["nivel-comprension"] == "❓" || p["nivel-comprension"] == "🤔")).length`
- 🟡 En progreso (💡): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Fundamentos-DS" && p["nivel-comprension"] == "💡").length`
- 🟢 Dominados (✅/🎯): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Fundamentos-DS" && (p["nivel-comprension"] == "✅" || p["nivel-comprension"] == "🎯")).length`
