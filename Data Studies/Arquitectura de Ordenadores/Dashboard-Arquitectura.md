...
- 🔴 Críticos (❓/🤔): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Arquitectura" && (p["nivel-comprension"] == "❓" || p["nivel-comprension"] == "🤔")).length`
- 🟡 En progreso (💡): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Arquitectura" && p["nivel-comprension"] == "💡").length`
- 🟢 Dominados (✅/🎯): `$= dv.pages('""').where(p => p.tipo_nota == "tecnica" && p.asignatura == "Arquitectura" && (p["nivel-comprension"] == "✅" || p["nivel-comprension"] == "🎯")).length`
